...
import { FRONT_DIR, FRONT_BUILD_SCRIPT } from "../../shared/libs/paths.js";
...
export function registerFrontendExecTools(server: McpServer) {
  ...
  server.tool(
    ...
    "Start, stop, or check status of a project's dev server on the oci-apps ARM runner (cloud-infra-mcp container).",
    {
      project: z.string().describe("Project name"),
