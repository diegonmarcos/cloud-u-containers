...
const log = (msg: string) => process.stderr.write(`[cloud-vault-mcp-http] ${msg}\n`);
const SESSION_ID = "cloud-vault-mcp-session";
...
export function startMcpHttpServer(port: number = 3111): Promise<void> {
