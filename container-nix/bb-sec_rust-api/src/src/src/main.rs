...
#[openapi(
    paths(
        ...
        routes::ondemand::vm_oci_flex_0_start,
        routes::ondemand::vm_oci_flex_0_stop,
        routes::ondemand::vm_oci_flex_0_reset,
        routes::ondemand::vm_oci_flex_1_start,
        routes::ondemand::vm_oci_flex_1_stop,
        routes::ondemand::vm_oci_flex_1_reset,
