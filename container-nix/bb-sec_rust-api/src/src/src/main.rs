...
#[openapi(
    paths(
        ...
        routes::ondemand::vm_oci_apps_start,
        routes::ondemand::vm_oci_apps_stop,
        routes::ondemand::vm_oci_apps_reset,
        routes::ondemand::vm_oci_apps_1_start,
        routes::ondemand::vm_oci_apps_1_stop,
        routes::ondemand::vm_oci_apps_1_reset,
