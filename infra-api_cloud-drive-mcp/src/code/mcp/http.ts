...
const log = (msg: string) => process.stderr.write(`[cloud-drive-mcp-http] ${msg}\n`);
const SESSION_ID = "cloud-drive-mcp-session";
...
export function startMcpHttpServer(port: number = 3109): Promise<void> {
