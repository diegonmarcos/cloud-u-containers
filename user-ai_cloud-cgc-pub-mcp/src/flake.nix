{
  description = "Cloud CGC MCP — Code Graph Context (infra knowledge, octocode, codegraph) — dist layout v2 (Type A, own code)";
  ...
  outputs = { self, nixpkgs }: let
    ...
    container = builtins.fromJSON (builtins.readFile ./build-cloud-cgc-pub-mcp.json);
