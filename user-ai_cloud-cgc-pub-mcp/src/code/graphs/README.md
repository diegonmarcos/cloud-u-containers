...
Canonical sources (do NOT edit here — copies):
  • build-kg-graph_delta.json      ← 1_cicd/dist (engine: deriveKgDelta)        [① infra, deterministic]
  • code-signatures-<repo>.json    ← 1_cicd/dist (engine: derive-code-signatures) [② code, deterministic]
