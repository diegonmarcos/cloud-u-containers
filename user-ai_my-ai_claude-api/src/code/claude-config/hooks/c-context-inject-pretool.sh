...
# Deployed: ~/.claude/hooks/c-context-inject-pretool.sh (copied by start.sh from /app/claude-config)
# ============================================================================
...
2. FULLY DATA-DRIVEN — never hardcode in scripts; data lives in `9_others/*.json` or `build.json`.
