...
|-------------|------------------------|------------------------|
| **Desktop** | `~/git/cloud-infra-desktop/ba_flakes_desktop/src/modules/dotfiles/claude/CLAUDE.md` | `~/.claude/CLAUDE.md` |
| **Termux** | `~/git/cloud-infra-desktop/bb_flakes_termux/src/modules/dotfiles/claude/CLAUDE.md` | `~/.claude/CLAUDE.md` |
...
1. Edit the source file in `~/git/cloud-infra-desktop/b{a,b}_flakes_{desktop,termux}/src/modules/dotfiles/claude/`
