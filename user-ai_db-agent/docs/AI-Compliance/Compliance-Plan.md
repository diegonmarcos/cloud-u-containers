...
**Source** (Termux): `~/git/cloud-unix/bb_flakes_termux/src/modules/dotfiles/claude/claude-guard.sh`
**Source** (Desktop): `~/git/cloud-unix/ba_flakes_desktop/src/modules/dotfiles/claude/claude-guard.sh`
...
[
  ...
  {"id":3,  "tool":"Bash",      "field":"command",   "pattern":"\\.claude/CLAUDE\\.md|\\.mcp\\.json",           "level":"critical_block", "message":"Edit source in ~/git/cloud-unix/ flakes, not deployed output"},
  ...
  {"id":18, "tool":"Edit|Write","field":"file_path", "pattern":"\\.claude/CLAUDE\\.md$",                        "level":"critical_block", "message":"Edit source in ~/git/cloud-unix/ flakes"},
  {"id":19, "tool":"Edit|Write","field":"file_path", "pattern":"\\.mcp\\.json$",                                "level":"critical_block", "message":"Edit source in ~/git/cloud-unix/ flakes"},
  ...
  {"id":22, "tool":"Edit|Write","field":"file_path", "pattern":"\\.claude/settings\\.json$",                    "level":"std_block",      "message":"Edit source in ~/git/cloud-unix/ flakes"},
...
**Source** (Termux): `~/git/cloud-unix/bb_flakes_termux/src/modules/dotfiles/claude/settings.json` — **CREATE**
**Source** (Desktop): `~/git/cloud-unix/ba_flakes_desktop/src/modules/dotfiles/claude/settings.json` — **EDIT**
...
**Source** (Termux): `~/git/cloud-unix/bb_flakes_termux/src/modules/dotfiles/claude/claude-memory.sh`
**Source** (Desktop): `~/git/cloud-unix/ba_flakes_desktop/src/modules/dotfiles/claude/claude-memory.sh`
...
- `~/git/cloud-unix/bb_flakes_termux/src/modules/dotfiles/claude/CLAUDE.md`
- `~/git/cloud-unix/ba_flakes_desktop/src/modules/dotfiles/claude/CLAUDE.md`
...
| File | Action |
|------|--------|
| `~/git/cloud-unix/bb_flakes_termux/src/modules/dotfiles/claude/claude-guard.sh` | **CREATE**: generic engine |
| `~/git/cloud-unix/bb_flakes_termux/src/modules/dotfiles/claude/claude-guard-rules.json` | **CREATE**: 33 rules (declarative) |
| `~/git/cloud-unix/bb_flakes_termux/src/modules/dotfiles/claude/settings.json` | **CREATE**: hooks config |
| `~/git/cloud-unix/bb_flakes_termux/src/modules/.../flake or common.nix` | Edit: home.file entries |
| `~/git/cloud-unix/ba_flakes_desktop/src/modules/dotfiles/claude/claude-guard.sh` | **CREATE**: sync engine |
| `~/git/cloud-unix/ba_flakes_desktop/src/modules/dotfiles/claude/claude-guard-rules.json` | **CREATE**: sync rules |
| `~/git/cloud-unix/ba_flakes_desktop/src/modules/dotfiles/claude/settings.json` | Edit: add hooks |
| `~/git/cloud-unix/bb_flakes_termux/src/modules/dotfiles/claude/claude-memory.sh` | **CREATE**: SessionStart hook |
| `~/git/cloud-unix/ba_flakes_desktop/src/modules/dotfiles/claude/claude-memory.sh` | **CREATE**: SessionStart hook |
| `~/git/cloud-unix/.../CLAUDE.md` (both) | Edit: replace rules with index |
