...
**Source** (Termux): `~/git/cloud-infra-desktop/bb_flakes_termux/src/modules/dotfiles/claude/claude-guard.sh`
**Source** (Desktop): `~/git/cloud-infra-desktop/ba_flakes_desktop/src/modules/dotfiles/claude/claude-guard.sh`
...
[
  ...
  {"id":3,  "tool":"Bash",      "field":"command",   "pattern":"\\.claude/CLAUDE\\.md|\\.mcp\\.json",           "level":"critical_block", "message":"Edit source in ~/git/cloud-infra-desktop/ flakes, not deployed output"},
  ...
  {"id":18, "tool":"Edit|Write","field":"file_path", "pattern":"\\.claude/CLAUDE\\.md$",                        "level":"critical_block", "message":"Edit source in ~/git/cloud-infra-desktop/ flakes"},
  {"id":19, "tool":"Edit|Write","field":"file_path", "pattern":"\\.mcp\\.json$",                                "level":"critical_block", "message":"Edit source in ~/git/cloud-infra-desktop/ flakes"},
  ...
  {"id":22, "tool":"Edit|Write","field":"file_path", "pattern":"\\.claude/settings\\.json$",                    "level":"std_block",      "message":"Edit source in ~/git/cloud-infra-desktop/ flakes"},
...
**Source** (Termux): `~/git/cloud-infra-desktop/bb_flakes_termux/src/modules/dotfiles/claude/settings.json` — **CREATE**
**Source** (Desktop): `~/git/cloud-infra-desktop/ba_flakes_desktop/src/modules/dotfiles/claude/settings.json` — **EDIT**
...
**Source** (Termux): `~/git/cloud-infra-desktop/bb_flakes_termux/src/modules/dotfiles/claude/claude-memory.sh`
**Source** (Desktop): `~/git/cloud-infra-desktop/ba_flakes_desktop/src/modules/dotfiles/claude/claude-memory.sh`
**Deployed to**: `~/.claude/hooks/claude-memory.sh` (via home-manager, executable, read-only)
**Reference**: `~/git/cloud-infra/.../ca-dat_db-agent/docs/AI-Compliance/dist/claude-memory.sh`
...
- `~/git/cloud-infra-desktop/bb_flakes_termux/src/modules/dotfiles/claude/CLAUDE.md`
- `~/git/cloud-infra-desktop/ba_flakes_desktop/src/modules/dotfiles/claude/CLAUDE.md`
...
See `~/git/cloud-infra/.../ca-dat_db-agent/docs/AI-Compliance/` for full spec.
```
...
- `~/git/cloud-infra/.../ca-dat_kg-graph/build.sh`
- `~/git/cloud-infra/.../bc-obs_rig/build.sh`
...
| File | Action |
|------|--------|
| `~/git/cloud-infra-desktop/bb_flakes_termux/src/modules/dotfiles/claude/claude-guard.sh` | **CREATE**: generic engine |
| `~/git/cloud-infra-desktop/bb_flakes_termux/src/modules/dotfiles/claude/claude-guard-rules.json` | **CREATE**: 33 rules (declarative) |
| `~/git/cloud-infra-desktop/bb_flakes_termux/src/modules/dotfiles/claude/settings.json` | **CREATE**: hooks config |
| `~/git/cloud-infra-desktop/bb_flakes_termux/src/modules/.../flake or common.nix` | Edit: home.file entries |
| `~/git/cloud-infra-desktop/ba_flakes_desktop/src/modules/dotfiles/claude/claude-guard.sh` | **CREATE**: sync engine |
| `~/git/cloud-infra-desktop/ba_flakes_desktop/src/modules/dotfiles/claude/claude-guard-rules.json` | **CREATE**: sync rules |
| `~/git/cloud-infra-desktop/ba_flakes_desktop/src/modules/dotfiles/claude/settings.json` | Edit: add hooks |
| `~/git/cloud-infra-desktop/bb_flakes_termux/src/modules/dotfiles/claude/claude-memory.sh` | **CREATE**: SessionStart hook |
| `~/git/cloud-infra-desktop/ba_flakes_desktop/src/modules/dotfiles/claude/claude-memory.sh` | **CREATE**: SessionStart hook |
| `~/git/cloud-infra-desktop/.../CLAUDE.md` (both) | Edit: replace rules with index |
| `~/git/cloud-infra/.../ca-dat_kg-graph/build.sh` | Edit: remove --exclude='.secrets' |
| `~/git/cloud-infra/.../bc-obs_rig/build.sh` | Edit: remove --exclude='.secrets' |
| `~/git/cloud-infra/.../docs/AI-Compliance/claude-guard.md` | Edit: fix exit codes + new rules |
| `~/git/cloud-infra/.../docs/AI-Compliance/Compliance-*.md` | Update: mirror plan + tasks |
