...
```json
{
  "mcpServers": {
    "cloud-infra": {
      "type": "stdio",
      "command": "npx",
      "args": ["tsx", "/data/data/com.termux.nix/files/home/git/cloud-infra/a_solutions/bb-sec_mcp-server-skills/src/index.ts"]
    }
  }
}
```
...
**Source**: `~/git/cloud-infra/a_solutions/bb-sec_mcp-server-skills/`
...
**Source**: `~/git/cloud-infra/a_solutions/bb-sec_mcp-server-skills/src/skills/`
...
**Deploy command**: `cd ~/git/cloud-infra/a_solutions/bb-sec_mcp-server-skills && ./build.sh deploy`
