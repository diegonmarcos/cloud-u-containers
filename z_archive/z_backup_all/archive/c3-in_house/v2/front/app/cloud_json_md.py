...
OUTPUT_DIR = SCRIPT_DIR / "cloud_exports"

# Input JSON files
ARCH_JSON = SCRIPT_DIR / "cloud_architecture.json"
MONITOR_JSON = SCRIPT_DIR / "cloud_control.json"
ARCH_API_JSON = SCRIPT_DIR / "cloud_architecture_api.json"
CTRL_API_JSON = SCRIPT_DIR / "cloud_control_api.json"

# Output files (all go to cloud_exports/)
ARCH_MD = OUTPUT_DIR / "cloud_architecture.md"
MONITOR_MD = OUTPUT_DIR / "cloud_control.md"
ARCH_API_MD = OUTPUT_DIR / "cloud_architecture_api.md"
CTRL_API_MD = OUTPUT_DIR / "cloud_control_api.md"
OPENAPI_ARCH_JSON = OUTPUT_DIR / "openapi_architecture.json"
OPENAPI_ARCH_YAML = OUTPUT_DIR / "openapi_architecture.yaml"
OPENAPI_CTRL_JSON = OUTPUT_DIR / "openapi_control.json"
OPENAPI_CTRL_YAML = OUTPUT_DIR / "openapi_control.yaml"
