...
Add a class = edit `9_others/src/inputs/notify-policy.json#severity_map.by_class`
and re-run `bash 9_others/build.sh all`. Never hardcode severity in the producer.
