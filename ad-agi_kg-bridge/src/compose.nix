# compose.nix — docker-compose for kg-bridge.
...
# kg-bridge claude`, and both the bridge's `claude -p` and your
...
let
  ...
  wgIp = svc."kg-bridge".ip or "10.0.0.6";
  home = "/home/appuser";
...
in
{
  ...
  volumes = {
    claude_home = { name = "kg-bridge-home"; };
  };
}
