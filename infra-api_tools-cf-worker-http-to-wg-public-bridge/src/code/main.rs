...
impl Config {
    fn from_env() -> Self {
        Self {
            ...
            listen_port: env::var("LISTEN_PORT").unwrap_or_else(|_| "8092".into()).parse().unwrap_or(8092),
            helo_domain: "cf-worker-bridge.diegonmarcos.com".into(),
...
async fn main() {
    ...
    info!(
        ...
        "CF-Worker → wg-public Bridge starting"
    );
