...
const log = (msg: string) => process.stderr.write(`[cloud-superapp-mcp-http] ${msg}\n`);
const SESSION_ID = "cloud-superapp-mcp-session";
...
export function startMcpHttpServer(port: number = 3110): Promise<void> {
