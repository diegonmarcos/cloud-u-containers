...
**Generated:** 2026-01-09 12:01:55 UTC
**Report ID:** 1767960115
...
Tests all services from the **outside** (as users would access them)
  ...
  - ❌ oci-p-flex_1 (Media) - Port 22 - SSH port 22 not accessible on 84.235.234.87
...
Uses **SSH** to gather system metrics from each VM
  ...
  - ❌ oci-p-flex_1 (84.235.234.87) - SSH accessible - Unreachable
