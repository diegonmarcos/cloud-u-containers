...
export function registerBuildTools(server) {
    server.tool("build_service", "Run build.sh for a specific service (build/secrets/ship/clean/all)", {
    ...
    server.tool("build_all", "Run the root build.sh orchestrator to build all services", {
