...
export function registerRustApiProxyTools(server) {
    server.tool("service_api_call", "Call any discovered service API endpoint. First use service_get_spec to understand available endpoints, then use this tool to make the actual call. Resolves service domain via Rust API discovery.", {
...
//# sourceMappingURL=rust-api-proxy.js.map