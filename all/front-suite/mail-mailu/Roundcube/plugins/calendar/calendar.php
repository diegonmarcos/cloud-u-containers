...
class calendar extends rcube_plugin
{
  ...
  public $gmt_offset;
  public $dst_active;  // PHP 8.2+ fix: declare property explicitly
  public $ui;
  public $token;         // PHP 8.2+ fix: used in itip_attend_response
  public $event;         // PHP 8.2+ fix: used in itip_attend_response
  public $invitestatus;  // PHP 8.2+ fix: used in itip_attend_response
